...
<div class="form-container">
    ...
    <div class="form-grid">
        <div class="form-group full-width">
            ...
            <?= $this->Form->select('car_id', $cars, ['class' => 'form-control', 'empty' => 'Choose a car...', 'required' => true]) ?>
        </div>
        ...
        <div class="form-group">
            ...
            ], ['class' => 'form-control', 'empty' => 'Select Service Type', 'required' => true]) ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?= $this->Form->select('status', [
                ...
                'Scheduled' => 'Scheduled'
            ], ['class' => 'form-control', 'default' => 'Completed']) ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?= $this->Form->number('cost', ['class' => 'form-control', 'step' => '0.01', 'min' => '0', 'default' => '0.00']) ?>
        </div>

        <div class="form-group">
            <label>Current Mileage (km)</label>
            <?= $this->Form->number('mileage', ['class' => 'form-control', 'min' => '0', 'placeholder' => 'e.g. 50000']) ?>
        </div>

        <div class="form-group full-width">
            <label>Description / Notes <span style="color: var(--text-light); font-size: 12px;">(Optional)</span></label>
            <?= $this->Form->textarea('description', ['class' => 'form-control', 'rows' => '3', 'placeholder' => 'Enter any additional details about this service...']) ?>
        </div>
    </div>

    <div style="margin-top: 20px;">
        <?= $this->Form->button('Save Record', ['class' => 'btn-submit']) ?>
