...
class CustomersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('ic_file_path')
            ->maxLength('ic_file_path', 255)
            ->requirePresence('ic_file_path', 'create')
            ->notEmptyString('ic_file_path');

        $validator
            ->scalar('license_file_path')
            ->maxLength('license_file_path', 255)
            ->requirePresence('license_file_path', 'create')
            ->notEmptyString('license_file_path');
